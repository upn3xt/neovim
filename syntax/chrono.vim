...
" --- Keywords ---
syntax keyword chronoKeyword fn var const if else while return pub int string char void use try catch as struct class module for attribute attributes constructor destroyer
